...
<template>
  <div class="autocomplete-wrapper">
    <input type="text" :class="$attrs.class" @keyup.passive="press" @keydown.enter="enter" @keydown.down="down" @keydown.up="up" v-model="label" @change="done" placeholder="Username">
